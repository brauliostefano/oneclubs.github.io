...
import { FileArchive, Zap, House, SquaresUnite, Mic2 } from 'lucide-react';
...
const MobileNav = () => {
  ...
  return (
    <nav className="fixed bottom-0 left-0 w-full z-[999] flex justify-center p-4 lg:hidden">
      <div className="flex w-full max-w-md justify-evenly items-center bg-zinc-950/80 backdrop-blur-xl border border-white/10 py-1 rounded-2xl shadow-[0_-10px_40px_rgba(0,0,0,0.5)]">
        {navItems.map((item, index) => (
          ...
          >
            ...
            <span className="text-[9px] font-black uppercase tracking-tighter text-zinc-600 group-hover:text-purple-300 transition-colors">
              {item.label}
            </span>
